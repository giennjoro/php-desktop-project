        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                   {!! Form::open(['action' => ['UsersController@update', $user->slug], 'method' => 'PUT', 'enctype' => 'multipart/form-data']) !!}
                        <div class="form-group">
                            ...
                            <div class="@if(!Auth::user()->supper) hidden @endif">
                                <input type="checkbox" name="supper" @if($user->supper) checked @endif }}>
                                {{ Form::label('supper', 'Make Supper Admin') }} <br> <br>
                            </div>
