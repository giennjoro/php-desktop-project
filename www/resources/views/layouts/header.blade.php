<header class="main-header">
        <!-- Logo -->
        <a target="_blank" href="https://24seven.co.ke" class="logo">
          <!-- mini logo for sidebar mini 50x50 pixels -->
          <span class="logo-mini"><b>24/</b>7</span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg"><b>24 Seven </b>Developers</span>
        </a>
              ...
              <li class="dropdown user user-menu">
                ...
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a href="{{ route('users.show', ['slug' => Auth::user()->slug]) }}" class="btn btn-default btn-flat">Profile</a>
                    </div>
